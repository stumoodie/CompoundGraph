...
public abstract class BaseGraphMoveBuilder implements ICompoundGraphMoveBuilder<BaseCompoundNode, BaseCompoundEdge> {
	...
	/**
	 * @see uk.ac.ed.inf.graph.compound.base.ICompoundGraphMoveBuilder#setSourceSubgraph(uk.ac.ed.inf.graph.compound.ISubCompoundGraph)
	 * 
	...
	/**
	 * @see uk.ac.ed.inf.graph.compound.base.ICompoundGraphMoveBuilder#setDestinatChildCompoundGraph(uk.ac.ed.inf.graph.compound.base.BaseChildCompoundGraph)
