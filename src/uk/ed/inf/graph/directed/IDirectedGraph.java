...
public interface IDirectedGraph extends IBasicGraph {
	 ...
	 */
	boolean containsDirectedEdge(IDirectedNode outNode, IDirectedNode inNode);
	 ...
	 */
	boolean containsDirectedEdge(IDirectedPair ends);
