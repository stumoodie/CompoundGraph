...
public class BaseCompoundNodeFactory implements ICompoundNodeFactory {
...
//		this.getParentNode().getChildCompoundGraph().addNewNode(retVal);
		getGraph().notifyNewNode(retVal);
		getParentNode().getChildCompoundGraph().notifyNewNode(retVal);
		return retVal;
	}
