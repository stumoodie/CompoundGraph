...
public class ArchetypalSubCompoundGraph implements ISubCompoundGraph<ArchetypalCompoundNode, ArchetypalCompoundEdge> {
	...
	public ArchetypalSubCompoundGraph(ArchetypalCompoundGraph superGraph){
