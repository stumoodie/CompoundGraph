...
//			allowing(mockSrcSubgraph).edgeLastElementIterator(); will(returnIterator(mockSrcNode1, mockSrcNode2, mockSrcNode3, mockSrcNode4, mockSrcEdge1, mockSrcEdge2));
			...
			allowing(mockSrcSubgraph).elementIterator(); will(returnIterator(testFixture.getNode1(), testFixture.getEdge1(), testFixture.getNode2(), testFixture.getEdge2(), testFixture.getNode3(), testFixture.getNode4()));
			allowing(mockSrcSubgraph).edgeLastElementIterator(); will(returnIterator(testFixture.getNode1(), testFixture.getNode2(), testFixture.getNode3(), testFixture.getNode4(), testFixture.getEdge1(), testFixture.getEdge2()));
