...
//	private static final int EXPECTED_LAST_EDGE_IDX = 8;
	...
	private IChildCompoundGraph testInstance;
	private ICompoundNode mockRootNode;
	private ICompoundNode mockNode1;
	private ICompoundNode mockNode2;
	private ICompoundNode mockNode3;
	private ICompoundNode mockNode4;
	private ICompoundNode mockNode7;
	private ICompoundEdge mockEdge1;
	private ICompoundEdge mockEdge2;
	private ICompoundEdge mockEdge4;
	private ICompoundEdge mockEdge7;
	private ICompoundNodePair mockEdge1Pair;
	private ICompoundNodePair mockEdge2Pair;
	...
	public void setUp() throws Exception {
		mockRootNode = this.mockery.mock(ICompoundNode.class, "mockRootNode");
		mockNode1 = this.mockery.mock(ICompoundNode.class, "mockNode1");
		mockNode2 = this.mockery.mock(ICompoundNode.class, "mockNode2");
		mockNode3 = this.mockery.mock(ICompoundNode.class, "mockNode3");
		mockNode4 = this.mockery.mock(ICompoundNode.class, "mockNode4");
		mockNode7 = this.mockery.mock(ICompoundNode.class, "mockNode7");
		mockEdge1 = this.mockery.mock(ICompoundEdge.class, "mockEdge1");
		mockEdge2 = this.mockery.mock(ICompoundEdge.class, "mockEdge2");
		mockEdge4 = this.mockery.mock(ICompoundEdge.class, "mockEdge4");
		mockEdge7 = this.mockery.mock(ICompoundEdge.class, "mockEdge7");
		mockEdge8 = this.mockery.mock(ICompoundEdge.class, "mockEdge8");
		mockEdge1Pair = this.mockery.mock(ICompoundNodePair.class, "mockEdge1Pair");
		mockEdge2Pair = this.mockery.mock(ICompoundNodePair.class, "mockEdge2Pair");
		...
		this.mockery.checking(new Expectations(){{
			...
			allowing(mockEdge1Pair).hasDirectedEnds(with(any(ICompoundNode.class)), with(not(same(mockNode2)))); will(returnValue(false));
			allowing(mockEdge1Pair).hasDirectedEnds(with(not(same(mockNode1))), with(any(ICompoundNode.class))); will(returnValue(true));
			
			allowing(mockEdge2Pair).hasDirectedEnds(with(same(mockNode2)), with(same(mockNode1))); will(returnValue(true));
			allowing(mockEdge2Pair).hasDirectedEnds(with(any(ICompoundNode.class)), with(not(same(mockNode1)))); will(returnValue(false));
			allowing(mockEdge2Pair).hasDirectedEnds(with(not(same(mockNode2))), with(any(ICompoundNode.class))); will(returnValue(true));
	...
	public final void testEmptySubCigraph() {
		final ICompoundNode mockRootNode = this.mockery.mock(ICompoundNode.class, "mockRootNode");
		final ICompoundGraph mockCigraph = this.mockery.mock(ICompoundGraph.class, "mockCigraph");
		this.mockery.checking(new Expectations(){{
			allowing(mockRootNode).getGraph(); will(returnValue(mockCigraph));
			allowing(mockRootNode).getRoot(); will(returnValue(mockRootNode));
		}});
...
//		final ICompoundEdge mockEdge7 = this.mockery.mock(ICompoundEdge.class, "mockEdge7");
//		final ICompoundNodePair mockEdge1Pair = this.mockery.mock(ICompoundNodePair.class, "mockEdge1Pair");
//		final ICompoundNodePair mockEdge2Pair = this.mockery.mock(ICompoundNodePair.class, "mockEdge2Pair");
//		final ICompoundNodePair mockEdge4Pair = this.mockery.mock(ICompoundNodePair.class, "mockEdge4Pair");
//		final ICompoundNodePair mockEdge7Pair = this.mockery.mock(ICompoundNodePair.class, "mockEdge7Pair");
...
//		final ICompoundEdge mockEdge4 = this.mockery.mock(ICompoundEdge.class, "mockEdge4");
//		final ICompoundEdge mockEdge7 = this.mockery.mock(ICompoundEdge.class, "mockEdge7");
//		final ICompoundEdge mockEdge8 = this.mockery.mock(ICompoundEdge.class, "mockEdge8");
//		final ICompoundNodePair mockEdge1Pair = this.mockery.mock(ICompoundNodePair.class, "mockEdge1Pair");
//		final ICompoundNodePair mockEdge2Pair = this.mockery.mock(ICompoundNodePair.class, "mockEdge2Pair");
//		final ICompoundNodePair mockEdge4Pair = this.mockery.mock(ICompoundNodePair.class, "mockEdge4Pair");
//		final ICompoundNodePair mockEdge7Pair = this.mockery.mock(ICompoundNodePair.class, "mockEdge7Pair");
////		final ICompoundNodePair mockEdge8Pair = this.mockery.mock(ICompoundNodePair.class, "mockEdge8Pair");
//		final ArchetypalCompoundGraph mockCigraph = this.mockery.mock(ArchetypalCompoundGraph.class, "mockCigraph");
//		this.mockery.checking(new Expectations(){{
//			allowing(mockRootNode).getGraph(); will(returnValue(mockCigraph));
//			allowing(mockRootNode).getRoot(); will(returnValue(mockRootNode));
...
//		this.testInstance.addNewEdge(mockEdge7);
		...
		ICompoundEdge expectedIterationOrder[] = { mockEdge1, mockEdge2, mockEdge4, mockEdge7 };
...
//		this.testInstance.addNewNode(mockNode2);
		...
		ICompoundNode expectedIterationOrder[] = { mockNode1, mockNode2 };
...
//		final ICompoundNode mockNode7 = this.mockery.mock(ICompoundNode.class, "mockNode7");
//		final ICompoundEdge mockEdge1 = this.mockery.mock(ICompoundEdge.class, "mockEdge1");
//		final ICompoundEdge mockEdge2 = this.mockery.mock(ICompoundEdge.class, "mockEdge2");
//		final ICompoundEdge mockEdge4 = this.mockery.mock(ICompoundEdge.class, "mockEdge4");
//		final ICompoundEdge mockEdge7 = this.mockery.mock(ICompoundEdge.class, "mockEdge7");
...
//		this.testInstance.addNewEdge(mockEdge7);
		this.mockery.assertIsSatisfied();
		final ISubCompoundGraph mockSubgraph = this.mockery.mock(ISubCompoundGraph.class, "mockSubgraph");
		final IChildCompoundGraph mockChildgraph0 = this.mockery.mock(IChildCompoundGraph.class, "mockChildgraph0");
		final IChildCompoundGraph mockChildgraph2 = this.mockery.mock(IChildCompoundGraph.class, "mockChildgraph2");
		final IChildCompoundGraph mockChildgraph3 = this.mockery.mock(IChildCompoundGraph.class, "mockChildgraph3");
		final ICompoundNode mockSubRootNode = this.mockery.mock(ICompoundNode.class, "mockSubRootNode");
		final ICompoundNode mockSubNode0 = this.mockery.mock(ICompoundNode.class, "mockSubNode0");
		final ICompoundNode mockSubNode1 = this.mockery.mock(ICompoundNode.class, "mockSubNode1");
		final ICompoundNode mockSubNode2 = this.mockery.mock(ICompoundNode.class, "mockSubNode2");
		final ICompoundNode mockSubNode3 = this.mockery.mock(ICompoundNode.class, "mockSubNode3");
		final ICompoundNode mockSubNode4 = this.mockery.mock(ICompoundNode.class, "mockSubNode4");
		final ICompoundEdge mockSubEdge1 = this.mockery.mock(ICompoundEdge.class, "mockSubEdge1");
		final ICompoundEdge mockSubEdge2 = this.mockery.mock(ICompoundEdge.class, "mockSubEdge2");
		final ICompoundEdge mockSubEdge3 = this.mockery.mock(ICompoundEdge.class, "mockSubEdge3");
		final ICompoundEdge mockSubEdge4 = this.mockery.mock(ICompoundEdge.class, "mockSubEdge4");
		final ICompoundNodePair mockSubEdge1Pair = this.mockery.mock(ICompoundNodePair.class, "mockSubEdge1Pair");
		final ICompoundNodePair mockSubEdge2Pair = this.mockery.mock(ICompoundNodePair.class, "mockSubEdge2Pair");
		final ICompoundNodePair mockSubEdge3Pair = this.mockery.mock(ICompoundNodePair.class, "mockSubEdge3Pair");
		final ICompoundNodePair mockSubEdge4Pair = this.mockery.mock(ICompoundNodePair.class, "mockSubEdge4Pair");
...
//			one(mockCigraph).getLcaNode(with(aNonNull(ICompoundNode.class)), with(aNonNull(ICompoundNode.class)));
			...
			allowing(mockSubEdge1).getChildCompoundGraph(); will(returnValue(mockChildgraph0));
...
//			allowing(mockSubEdge1Pair).getTwoNode(); will(returnValue(mockSubNode2));
			...
			allowing(mockSubEdge2).getChildCompoundGraph(); will(returnValue(mockChildgraph2));
...
//			allowing(mockSubEdge2Pair).getTwoNode(); will(returnValue(mockSubNode2));
			...
			allowing(mockSubEdge3).getChildCompoundGraph(); will(returnValue(mockChildgraph3));
...
//			allowing(mockSubEdge3Pair).getTwoNode(); will(returnValue(mockSubNode3));
			...
			allowing(mockSubEdge4).getChildCompoundGraph(); will(returnValue(mockChildgraph0));
			...
			allowing(mockChildgraph0).getRoot(); will(returnValue(mockSubRootNode));
			
			allowing(mockChildgraph2).getRoot(); will(returnValue(mockSubNode2));
			
			allowing(mockChildgraph3).getRoot(); will(returnValue(mockSubNode3));
		}});
...
//		final ICompoundNodePair<CiNode, CiEdge> mockEdge1Pair = this.mockery.mock(ICompoundNodePair.class, "mockEdge1Pair");
//		final ICompoundNodePair<CiNode, CiEdge> mockEdge2Pair = this.mockery.mock(ICompoundNodePair.class, "mockEdge2Pair");
//		final ICompoundNodePair<CiNode, CiEdge> mockEdge4Pair = this.mockery.mock(ICompoundNodePair.class, "mockEdge4Pair");
//		final ICompoundNodePair<CiNode, CiEdge> mockEdge7Pair = this.mockery.mock(ICompoundNodePair.class, "mockEdge7Pair");
//		final ICompoundNodePair<CiNode, CiEdge> mockEdge8Pair = this.mockery.mock(ICompoundNodePair.class, "mockEdge8Pair");
