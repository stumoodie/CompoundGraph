...
public class NodeElementAttributeCopyFactory implements	IElementAttributeFactory {
	private final NodeElementAttribute attribToCopy;
	...
	public NodeElementAttributeCopyFactory(NodeElementAttribute attrbToCopy){
	...
	public NodeElementAttribute createAttribute() {
		return new NodeElementAttribute(this.attribToCopy);
	}
