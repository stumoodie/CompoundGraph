...
@RunWith(JMock.class)
public class SubGraphWithRemovedNodesAndRootTest {
	...
	public void setUp() throws Exception {
		...
		this.testInstance.addElement(this.testFixture.getRootNode());
		...
		this.testInstance.addElement(this.testFixture.getNode6());
