...
@RunWith(JMock.class)
public class CompoundNodeFactoryNonParentingAttributeTest {
	private Mockery mockery;
	private ComplexGraphFixture testFixture;
	private ICompoundNodeFactory testInstance;
	private IElementAttributeFactory expectedAttributeFactory;
	...
	public void testGetAttributeFactory(){
		assertEquals("expected attribute", this.expectedAttributeFactory, this.testInstance.getAttributeFactory());
	}
