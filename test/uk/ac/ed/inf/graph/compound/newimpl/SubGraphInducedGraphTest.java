...
public class SubGraphInducedGraphTest {
	...
	public void setUp() throws Exception {
		...
		this.testInstance.addElement(this.testFixture.getNode3());
		this.testInstance.addElement(this.testFixture.getNode5());
	...
	public void testContainsElementICompoundGraphElement() {
		...
		assertFalse("element not present", this.testInstance.containsElement(this.testFixture.getNode4()));
	...
	public void testContainsElementInt() {
		...
		assertFalse("element not present", this.testInstance.containsElement(this.testFixture.getNode4().getIndex()));
	...
	public void testContainsNodeInt() {
		...
		assertFalse("no node present", this.testInstance.containsNode(this.testFixture.getNode4().getIndex()));
	...
	public void testContainsNodeICompoundNode() {
		assertFalse("no element present", this.testInstance.containsNode(this.testFixture.getNode4()));
	...
	public void testElementIterator() {
		IteratorTestUtility<ICompoundGraphElement> testIter = new IteratorTestUtility<ICompoundGraphElement>(this.testFixture.getNode1(), this.testFixture.getNode2(), this.testFixture.getNode3(), this.testFixture.getNode5(),
	...
	public void testGetEdgeOutsideEdge() {
		assertNull("null", this.testInstance.getEdge(this.testFixture.getEdge1().getIndex()));
	}
	...
	public void testGetElement() {
		...
		assertEquals("expected node", this.testFixture.getNode3(), this.testInstance.getElement(this.testFixture.getNode3().getIndex()));
	}
	...
	public void testAddElement() {
		ICompoundEdge expectedElement = this.testFixture.getEdge1();
		this.testInstance.addElement(expectedElement);
		...
		assertTrue("contains edge", this.testInstance.containsEdge(expectedElement));
		assertTrue("contains edge", this.testInstance.containsEdge(expectedElement.getIndex()));
		IteratorTestUtility<ICompoundGraphElement> testIter = new IteratorTestUtility<ICompoundGraphElement>(this.testFixture.getNode1(), this.testFixture.getNode2(),
				this.testFixture.getNode3(), this.testFixture.getNode5(), this.testFixture.getEdge1(), this.testFixture.getEdge2(), this.testFixture.getEdge3(),
