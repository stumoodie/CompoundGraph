...
import uk.ac.ed.inf.graph.compound.newimpl.SubCompoundGraph;
import uk.ac.ed.inf.graph.compound.testfixture.ComplexGraphFixture;
import uk.ac.ed.inf.graph.compound.testfixture.IteratorTestUtility;

@RunWith(JMock.class)
public class SubCompoundGraphInducedGraphTest {
	...
	private static final int EXPECTED_NUM_TOP_NODES = 3;
	private static final int EXPECTED_NUM_ELEMENTS = 8;
	private static final int EXPECTED_NUM_TOP_ELEMENTS = 5;
	private static final int EXPECTED_NUM_TOP_EDGES = 2;
...
//		this.otherTestFixture.buildObjects();
		...
		this.testInstance.addTopElement(this.testFixture.getNode3());
		this.testInstance.addTopElement(this.testFixture.getNode5());
	...
	public void testContainsDirectedEdgeICompoundNodeICompoundNode() {
		...
		assertTrue("edge exists", this.testInstance.containsDirectedEdge(testOutsidePair.getOutNode(), testOutsidePair.getInNode()));
	...
	public void testContainsDirectedEdgeCompoundNodePair() {
		...
		CompoundNodePair testOutsidePair = this.testFixture.getEdge4().getConnectedNodes();
		assertTrue("edge exists", this.testInstance.containsDirectedEdge(testOutsidePair));
		CompoundNodePair testOtherGraphPair = this.otherTestFixture.getEdge2().getConnectedNodes();
	...
	public void testContainsNodeInt() {
		...
		assertTrue("node present", this.testInstance.containsNode(this.testFixture.getNode5().getIndex()));
	...
	public void testEdgeIterator() {
		IteratorTestUtility<ICompoundEdge> testIter = new IteratorTestUtility<ICompoundEdge>(this.testFixture.getEdge2(), this.testFixture.getEdge3(), this.testFixture.getEdge4());
		testIter.testSortedIterator(this.testInstance.edgeIterator());
	}

	@Test
	public void testElementIterator() {
		IteratorTestUtility<ICompoundGraphElement> testIter = new IteratorTestUtility<ICompoundGraphElement>(this.testFixture.getNode1(), this.testFixture.getNode2(), this.testFixture.getNode3(), this.testFixture.getNode4(), this.testFixture.getNode5(),
	...
	public void testNodeIterator() {
		IteratorTestUtility<ICompoundNode> testIter = new IteratorTestUtility<ICompoundNode>(this.testFixture.getNode1(), this.testFixture.getNode2(), this.testFixture.getNode3(),
				this.testFixture.getNode4(), this.testFixture.getNode5());
	...
	public void testTopElementIterator() {
		IteratorTestUtility<ICompoundGraphElement> testIter = new IteratorTestUtility<ICompoundGraphElement>(this.testFixture.getNode1(), this.testFixture.getNode3(),
				this.testFixture.getNode5(), this.testFixture.getEdge2(), this.testFixture.getEdge4());
		testIter.testSortedIterator(this.testInstance.topElementIterator());
	}

	@Test
	public void testTopNodeIterator() {
		IteratorTestUtility<ICompoundNode> testIter = new IteratorTestUtility<ICompoundNode>(this.testFixture.getNode1(), this.testFixture.getNode3(),
				this.testFixture.getNode5());
	...
	public void testEdgeLastElementIterator() {
		IteratorTestUtility<ICompoundGraphElement> testIter = new IteratorTestUtility<ICompoundGraphElement>(this.testFixture.getNode1(), this.testFixture.getNode2(), this.testFixture.getEdge3(), this.testFixture.getNode3(),
				this.testFixture.getNode5(), this.testFixture.getEdge2(), this.testFixture.getNode4(), this.testFixture.getEdge4());
	...
	public void testAddTopNode() {
		...
		IteratorTestUtility<ICompoundGraphElement> testIter = new IteratorTestUtility<ICompoundGraphElement>(this.testFixture.getNode1(), this.testFixture.getNode3(), this.testFixture.getNode5(), this.testFixture.getEdge2(), this.testFixture.getEdge4());
		testIter.testSortedIterator(this.testInstance.topElementIterator());
	}
