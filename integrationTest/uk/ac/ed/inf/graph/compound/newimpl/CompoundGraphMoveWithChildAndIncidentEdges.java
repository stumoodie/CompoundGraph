...
public class CompoundGraphMoveWithChildAndIncidentEdges {
	...
	private CompoundGraphMoveWithChildAndIncidentEdgesGraphTestFixture testFixture;
	private ICompoundNode node6;
	private ICompoundEdge edge3;	
	
	@Before
	public void setUp() throws Exception {
		this.testFixture = new CompoundGraphMoveWithChildAndIncidentEdgesGraphTestFixture();
...
//		edge2 = edgeFact.createEdge();
	...
	public void testMoveWithIncidentEdge() {
		...
		assertTrue("expected elements", newEdge1.getChildCompoundGraph().containsNode(newNode5));
